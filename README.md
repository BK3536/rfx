...
- [SBP-SAT Subgridding guide](docs/public/guide/subgridding.mdx) — experimental all-PEC arbitrary-box + selected reflector/periodic subset; proxy benchmark only
