...
def _make_nonuniform_full_axis_supported_sim(*, boundary: str = "pec") -> Simulation:
    sim = Simulation(
        freq_max=5e9,
        domain=(0.015, 0.015, 0.015),
        boundary=boundary,
    ...
    sim.add_source((0.0045, 0.0075, 0.0045), "ez", waveform=GaussianPulse(f0=3e9, bandwidth=0.5))
...
def test_phase5_nonuniform_support_inspection_accepts_full_axis_source_probe():
    sim = _make_nonuniform_full_axis_supported_sim()
...
def test_phase5_nonuniform_support_inspection_accepts_cpml_full_axis_source_probe():
    sim = _make_nonuniform_full_axis_supported_sim(boundary="cpml")
...
def test_phase5_nonuniform_prepare_bundle_supports_full_axis_source_probe():
    sim = _make_nonuniform_full_axis_supported_sim()
...
def test_phase5_nonuniform_full_axis_forward_matches_pure_ad_pec():
    sim = _make_nonuniform_full_axis_supported_sim()
...
def test_phase5_nonuniform_full_axis_forward_matches_pure_ad_cpml():
    sim = _make_nonuniform_full_axis_supported_sim(boundary="cpml")
...
def test_phase5_nonuniform_full_axis_gradient_matches_pure_ad():
    sim = _make_nonuniform_full_axis_supported_sim()
    grid = sim._build_nonuniform_grid()
    materials, *_ = sim._assemble_materials_nu(grid)
