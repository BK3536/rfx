...
This budget gate currently targets the built-in streaming proxy objectives. It
is not a universal guarantee for arbitrary custom objectives or experimental
NTFF-driven paths. It is also backend-dependent: if a backend reports
