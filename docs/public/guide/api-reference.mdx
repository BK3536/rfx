...
The `Simulation` builder is the main high-level interface in `rfx`. The current public docs track the stable v1.4.0 surface plus a few documented main-branch improvements.
